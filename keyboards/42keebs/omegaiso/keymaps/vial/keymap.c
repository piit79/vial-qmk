...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_tklish_iso(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_RSFT, KC_RSFT,                      KC_UP,
      KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_SPC,  KC_SPC,  KC_RGUI, KC_RALT,  KC_APP,  KC_RCTL,            KC_LEFT,  KC_DOWN, KC_RIGHT),
  ...
  [1] = LAYOUT_tklish_iso(
      ...
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,            KC_TRNS,  KC_VOLD, KC_TRNS),
